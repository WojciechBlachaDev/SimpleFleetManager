...
namespace SimpleFleetManager.ViewModels.Main
{
    public class ForkliftsPageViewModel : BaseViewModel
    {
        ...
        {
            get { return _forkliftsCurrentPage ?? new(); }
            set { _forkliftsCurrentPage = value; OnPropertyChanged(nameof(ForkliftsCurrentPage)); }
        }
        ...
        {
            get { return _avaibleForklifts ?? []; }
            set { _avaibleForklifts = value; OnPropertyChanged(nameof(AvaibleForklifts)); }
        }
        private bool _isComboboxOpened;
        public bool IsComboboxOpened
        {
            get { return _isComboboxOpened; }
            set { _isComboboxOpened = value; OnPropertyChanged(nameof(IsComboboxOpened)); }
        }
        private int _currentPageNumber;
        public int CurrentPageNumber
        {
            get { return _currentPageNumber; }
            set { if (_currentPageNumber != value) { _currentPageNumber = value; OnPropertyChanged(nameof(CurrentPageNumber)); } }
        }
